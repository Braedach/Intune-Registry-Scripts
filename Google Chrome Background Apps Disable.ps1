#Remediation for Bacckground mode enabled in Google Chrome
...
If (Get-ItemProperty -Path 'Registry::HKLM\SOFTWARE\Policies\Google\Chrome\')
    ...
    Write-Output "True"
    Set-Itemproperty -Path 'Registry::HKLM\SOFTWARE\Policies\Google\Chrome\' -Name 'BackgroundModeEnabled' -value '0'
    Get-ItemProperty -Path 'Registry::HKLM\SOFTWARE\Policies\Google\Chrome\' -Name BackgroundModeEnabled
    }
    else
    {
     ...
     New-ItemProperty -Path 'Registry::HKLM\SOFTWARE\Policies\Google\Chrome\' -Name 'BackgroundModeEnabled' -value '0'
     Get-ItemProperty -Path 'Registry::HKLM\SOFTWARE\Policies\Google\Chrome\' -Name BackgroundModeEnabled
     }