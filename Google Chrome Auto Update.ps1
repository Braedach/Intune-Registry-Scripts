...
If (Get-ItemProperty -Path 'Registry::HKLM\SOFTWARE\Policies\Google\Update')
    ...
    #Write-Output "True"
    Set-Itemproperty -Path 'Registry::HKLM\SOFTWARE\Policies\Google\Update' -Name 'Updatedefault' -value '1'
    ...
    else
    {
     ...
     New-Item -Path 'Registry::HKLM\SOFTWARE\Policies\Google\Update' -Name 'Updatedefault' -value '1'
     Get-ItemProperty -Path 'Registry::HKLM\SOFTWARE\Policies\Google\Update' -Name Updatedefault
     }
